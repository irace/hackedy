...
// BRYKit
#define COCOAPODS_POD_AVAILABLE_BRYKit
#define COCOAPODS_VERSION_MAJOR_BRYKit 1
#define COCOAPODS_VERSION_MINOR_BRYKit 0
#define COCOAPODS_VERSION_PATCH_BRYKit 0
